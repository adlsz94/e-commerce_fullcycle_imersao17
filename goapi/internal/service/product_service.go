...
import (
	"github.com/adlsz94/e-commerce_fullcycle_imersao17/goapi/internal/database"
	"github.com/adlsz94/e-commerce_fullcycle_imersao17/goapi/internal/entity"
)
...
func (ps *ProductService) CreateProduct(name, description string, price float64, category_id string, image_url string) (*entity.Product, error) {
